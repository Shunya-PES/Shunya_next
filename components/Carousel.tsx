...
<h1 className="heading font-medium leading-tight text-5xl mt-0 mb-2 text-blue-600" style={{marginLeft: '45vw',marginTop:'5vh',fontWeight: 'bolder'}}>Events</h1>
<div className="box">
<div className="carousel relative shadow-2xl bg-white">
	<div className="carousel-inner relative overflow-hidden w-full">
	  
		<input className="carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true" checked hidden/>
		<div className="carousel-item absolute opacity-0">
			<div>
        <img className='imgclass' src="https://shunyapes.com/Assets/eventsPage/faceOff.webp " alt=""/>
      </div>
      <div className="carousel-text">
        <h2 className="parah font-medium leading-tight text-4xl mt-0 mb-2 text-blue-600">1. Face-Off</h2>
        <p className="para">            Team Shunya is super excited to inform you that we are going to be
		...
		<div className="carousel-item absolute opacity-0">
			<div>
        <img  className="imgclass" src="https://shunyapes.com/Assets/eventsPage/arithmania.webp " alt=""/>
      </div>
      <div className="carousel-text">
        <h2 className="parah font-medium leading-tight text-4xl mt-0 mb-2 text-blue-600">2. Arithemania</h2>
        <p className="para">            Team Shunya is super excited to inform you that we are going to be
            hosting our very first event in the month of April. But before
            that what is even better is that we are organising a very fun
            event for all PES RR and EC Campus students on 18th March. Make
		...
		<div className="carousel-item absolute opacity-0">
			<div>
        <img src="https://shunyapes.com/Assets/eventsPage/arithmania.webp" alt=""/>
      </div>
      <div className="carousel-text">
        <h2 className="font-medium leading-tight text-4xl mt-0 mb-2 text-blue-600">3.Arithemania</h2>
        <p>            Team Shunya is super excited to inform you that we are going to be
            hosting our very first event in the month of April. But before
            that what is even better is that we are organising a very fun
            event for all PES RR and EC Campus students on 18th March. Make
            sure you attend the event to stand a chance to win exciting prizes
