  ...
  return (
    <nav className="md:w-[60px] md:h-screen md:fixed md:bg-background md:flex md:flex-col md:justify-center md:border-r md:border-white z-50">
      <div className="hidden md:flex md:flex-col md:items-center md:justify-center md:gap-12">
        ...
        >
          <Image
            className="md:h-[25px] md:w-[25px] md:group-hover:scale-90 md:duration-300 md:ease-in-out"
            src={HomeIcon}
            alt="Home"
          />
      ...
      <div className="md:hidden">
        <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="">
          {isMenuOpen ? (
            <Image
              className="h-[35px] w-[35px] fixed top-[20px] left-[20px] z-50"
              src={CloseIcon}
              alt="Close"
            />
          ) : (
        ...
        {isMenuOpen && (
          <div className="bg-background border border-white rounded fixed z-50 top-[65px] left-[20px]">
            <div className="flex flex-col">
              <Link
                className="flex flex-row items-center gap-[15px] mt-7 mb-7 pl-5 pr-5 cursor-pointer"
                href="/"
              >
                <Image
              ...
              <Link
                className="flex flex-row items-center gap-[15px] mb-7 pl-5 pr-5 cursor-pointer"
                href="/"
              >
                <Image
                  className="w-[25px] h-[25px]"
